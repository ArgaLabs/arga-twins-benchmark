#!/usr/bin/env python3
"""Run independent Cross-Functional 40 repeats with shared provider limits."""
...
import run_cross_functional_model_matrix as matrix
...
def validate_existing_config(
    ...
    *,
    ...
    if typed_payload.get("suite_id") != "cross-functional-40-v1":
...
async def async_main(args: argparse.Namespace) -> int:
    ...
    parent_config = {
        "protocol": "arga-bench-cross-functional-model-repeats/1",
        "suite_id": "cross-functional-40-v1",
