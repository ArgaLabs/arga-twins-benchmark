#!/usr/bin/env python3
# ruff: noqa: E501
"""Build the evidence-backed report for the corrected ArgaBench run."""
...
def main() -> int:
    ...
    prior_diagnostic_dir = run_dir.parent / "argabench-40-staging-fable5-high-20260815"
    ...
    (run_dir / "TOOL_STEPS.json").write_text(
        json.dumps(
            {
                "protocol": "argabench-tool-steps/1",
                "task_count": 40,
    ...
    lines = [
        "# ArgaBench — Fable 5 High corrected staging run",
        "",
    ...
    lines.extend(
        [
            ...
            "## Prompt provenance",
            "",
            "Every recorded candidate prompt exactly matches `benchmark/argabench_40/TASKS.md` and its current "
