"""Audit trace, twin-state, and verdict evidence for ArgaBench repeats.
...
def main() -> int:
    ...
    suite_path = Path(__file__).resolve().parents[1] / "benchmark" / "argabench_40" / "suite.json"
    ...
    payload = {
        "protocol": "argabench-trial-evidence-audit/1",
        "scope": {
