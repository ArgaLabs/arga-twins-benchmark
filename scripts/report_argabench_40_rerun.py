#!/usr/bin/env python3
"""Validate and report one fresh ArgaBench rerun."""
...
def main() -> int:
    ...
    (run_dir / "TOOL_STEPS.json").write_text(
        json.dumps(
            {
                "protocol": "argabench-tool-steps/2",
                "task_count": 40,
    ...
    lines = [
        "# ArgaBench — Fable 5 High fairness-revision rerun",
        "",
