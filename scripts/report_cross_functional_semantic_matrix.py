#!/usr/bin/env python3
"""Build the offline semantic report and gated website exports for Cross-Functional 40."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("matrix_dir", type=Path, help="Preserved 30-profile matrix directory (read-only).")
