...
The packager reads readiness.json and rejects release until all required checks carry verified, content-hashed evidence. Evidence files must live under samples/workspace/evidence and are included in the ZIP. The gate also binds evidence to a SHA-256 digest of the current runner source, fixtures, task contracts and dependencies. There is no override flag.
