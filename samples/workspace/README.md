...
PR #1158 adds native filter-view validation/preview and effective color filtering/sorting with 536 passing local Sheets/shared Workspace regressions and successful CI at6d796c6a (5,476 twin and2,106 root tests). A disposable real Sheets fixture verified temporary/saved lifecycle, sorted edit mapping and view-dependent formula display; it was moved to trash. Filter-view frontend controls, sorted-view editing and browser checks remain unfinished; it is not deployed. See `sheets-filter-views-colors-2026-09-24.json`.
