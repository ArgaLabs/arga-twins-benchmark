...
- PR #1136 serves native Linear project/document/issue/comment/profile paths, including archived resources. All 116 Linear tests pass and local Chrome/native checks pass. CI passed and the PR merged at `47243201`; production is retrying a Docker Hub 502 and hosted validation remains pending. See `linear-native-links.json`.
...
- PR #1138 adds typed nested AND/OR filters to Notion views. All 158 Notion tests pass, including the review follow-up for emptiness-operator precedence; desktop and 390px Chrome editing preserve protected records. CI/deployment/hosted validation remain pending. See `notion-nested-filters.json`.
...
- PR #1139 adds Linear project overview properties, native content/members, documents, milestones, and updates. All 133 Linear tests and local Chrome desktop/390px flows pass; CI, deployment and hosted replay remain pending. See `linear-project-overview.json`.
