...
Sheets merge-cell controls and rendering are in PR #1101, with 162 regressions plus Chrome desktop/390px checks of warning cancellation, merge modes, unmerge, hidden/offscreen anchors and frozen rows. Border/frozen-pane integration is verified locally in PR #1099. Hosted merge/border validation and their combined integration remain pending.
